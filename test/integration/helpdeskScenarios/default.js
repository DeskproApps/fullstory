...
addScenario('default', {
  ...
  'context.property.get': function({ path, type, tabId }) {
    ...
    const stringPath = path instanceof Array ? path.join('.') : null;

    return {
      body: stringPath === 'data.person_email' ? 'joe.kool@deskpro.com' : null,
      status: 'success',
    };
  ...
  'webapi.request.fetch': function({ url, method, headers, mode, body }) {
    ...
    if (url === 'https://www.fullstory.com/api/v1/sessions?email=joe.kool@deskpro.com') {

      return {
        body: {
          status: 200,
          body: [
            { UserId:123, SessionId: 456, CreatedTime: 1476470464, FsUrl: "https://www.fullstory.com/ui/ORG_ID/discover/session/1234567890:1234567890" },
            { UserId:124, SessionId: 457, CreatedTime: 1476500464, FsUrl: "https://www.fullstory.com/ui/ORG_ID/discover/session/1234567890:2234567890" },
            { UserId:125, SessionId: 458, CreatedTime: 1476900464, FsUrl: "https://www.fullstory.com/ui/ORG_ID/discover/session/1234567890:3234567890" }
          ],
          headers: {
